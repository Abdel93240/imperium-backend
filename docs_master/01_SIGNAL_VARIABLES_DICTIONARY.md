...
| mission_estimated_duration | Imperium | Imperium | integer nullable | `45` | Imperium, Pulse, Vector | system/AI | mission create/update | ai_inferred | medium | yes | yes | summary_only | Minutes. Jamais demandé à l'utilisateur mission par mission ; appris du réel par similarité vectorielle de libellé (règle: doc 09). Défaut IA NON CONFIRMÉ tant que l'historique est vide, auto-corrigé semaine après semaine. |
