...
| ImperiumBottomNavigation | Navigation primaire phone. | Afficher 3-5 destinations top-level V1. | App `Background/Surface`, `Accent`, `TextSecondary`, `IconSize.Navigation`, `Typography.Label`, `Elevation.L4`. | 3, 4, 5 items. | Active, inactive, disabled, focused. | Libelle visible; item actif pas seulement couleur. | Non primaire sur Tab S10 Ultra; absent ou remplace par sidebar. | Phone portrait seulement. | Tablet landscape, dialogs, nested panes. |
