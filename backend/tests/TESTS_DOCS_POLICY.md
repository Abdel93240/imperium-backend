...
- `test_imperium_frontend_theme_tokens.py::test_frontend_theme_tokens_docs_metadata_only_static_v1_not_dynamic_theme_preference_health_or_discovery` supprime: verifiait uniquement des phrases de docs theme-tokens, deja couvert cote code par endpoint/shape/read-only/no-DB-write.
