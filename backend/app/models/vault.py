...
class LegacyVaultTransaction(UUIDPrimaryKeyMixin, Base):
    ...
    __table_args__ = (
        ...
        Index("vault_transactions_user_occurred_at_idx", "user_id", desc("occurred_at")),
    ...
    source_app: Mapped[str] = mapped_column(Text, nullable=False, server_default="vault")
