...
HORIZON 2 — ROLLING MONTHLY (4-week glide)
  Generated every Monday morning by Opus 4.7.
...
CREATE TABLE imperium_monthly_plans (
  ...
  generation_model         VARCHAR(32), -- 'opus-4.7' or 'gpt-5.5'
  plan_json                JSONB,
  warnings                 TEXT[],
...
CREATE TABLE imperium_daily_plans (
  ...
  plan_json           JSONB,
  generated_at        TIMESTAMPTZ,
  generated_model     VARCHAR(32), -- 'sonnet-4.6' typically
...
- Possible plan adaptation (Sonnet)
